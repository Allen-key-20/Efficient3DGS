...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, args):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        torchvision.utils.save_image(rendering.permute(2, 0, 1), os.path.join(render_path, '{0:05d}'.format(idx) + ".png"))
        torchvision.utils.save_image(gt.permute(2, 0, 1), os.path.join(gts_path, '{0:05d}'.format(idx) + ".png"))
